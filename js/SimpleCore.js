...
var SimpleCore = {
    ...
    init: function (params) {
        ...
        $(document).on('click', '.btn-sns-qr', function (e) {
            ...
            if (SimpleCore.snsQRCode != '') {
                SimpleCore.alert('hello~','<img style="width:180px;background:#fff;" src="' + SimpleCore.snsQRCode + '">');
            } else {
    ...
    changeReadModel: function () {
        ...
        if (SimpleCore.getLocalData('read-mode') == 'night') {
            ...
            $(".cover-img").css({
                'background': "url('https://ws1.sinaimg.cn/large/006f2SyGgy1g0ssaq74a5j30fx0o6qlb.jpg')",
                'background-image': 'url(https://ws1.sinaimg.cn/large/006f2SyGgy1g0ssaq74a5j30fx0o6qlb.jpg)',
                'background-size': 'cover',
                'background-position': 'center',
                'background-repeat': 'no-repeat'
            });
